                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <main role="main" className="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                                    ...
                                    <tbody>
                                        {
                                            myArray.map(myArray =>
                                              ...
                                              <td><Link to={"/AnimalProfile/" + myArray.animalId}> <button className="btn btn-primary" type="submit">Go</button></Link></td> 
                                            </tr>)
                                        }
                            ...
                            <br/>
                            <Link to={"/AnimalHealthTechAddAnimal"}> <button className="btn btn-primary" type="submit">Add Animal</button></Link>
                        </main>
                    </div>
                </div>
            </form >
